...
//          * @default
//          */
//         licenseKey : 'qsvi9kitd5ujiwls7y7ft4wtawq6gpzbvwd1wwz4h9rby12w',
...
//         // The HTML that belongs to the *current* grid cell
//         const html = me.value ?? '';

//         // No live editor? Create a fresh one and seed it with the cell value
//         if (!me.editor) {
